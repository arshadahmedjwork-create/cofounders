...
export const DEMO_PROFILES: Profile[] = [
  ...
  },
  {
    id: "demo-3",
    name: "Elena Petrova",
    role: "Aspirant Founder",
    domain: "SaaS / B2B",
    location: "London, UK",
    bio: "Scaling expert who took a SaaS from 0 to 1M ARR in 14 months. Now looking to join an early-stage team as a late co-founder or COO.",
    ...
    hasTakenSynapse: true,
    intent: 'joining',
    work: "Ex-CMO at CloudScale, grew community to 100K+ members. Specialized in low-CAC acquisition loops.",
